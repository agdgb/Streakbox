...
| **2** | **"Streaks can become toxic"** (Missed day drops streak to 0 ➔ user abandons app) | 🔴 **CRITICAL** | **Dual-Metric Engine**: Consistency Score (e.g. `96%`) + **"Never Miss Twice" Recovery Protocol** + Grace Days. | `lib/state/calendar_providers.dart`, `lib/features/calendar/widgets/consistency_badge.dart` | 🟢 **READY TO BUILD** |
...
| **9** | **"Onboarding is absent (Cold Start)"** (New user sees empty calendar and uninstalls) | 🔴 **CRITICAL** | **30-Second Fast-Track Onboarding**: Starter habit packs (🏃 Fitness, 📚 Focus, 💧 Health) + instant Day 1 check-in. | `lib/features/onboarding/onboarding_screen.dart` | 🟢 **READY TO BUILD** |
